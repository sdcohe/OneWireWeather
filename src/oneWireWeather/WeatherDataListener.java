/* SVN FILE: $Id: WeatherDataListener.java 134 2013-07-19 19:32:22Z seth $ */
/**
...
* $URL: https://mustang:8443/svn/projects/OneWireWeather/src/oneWireWeather/WeatherDataListener.java $
 ...
 * about changes to the weather station date.  Interested listeners 
 * implement this interface and then register themselves with the weather station
 * through the addWeatherDataListener() method.  
 * 
 * @author Seth Cohen
 *
 */
public interface WeatherDataListener {
     ...
     * the weather data changes.  This allows a class to implement this
     * interface and be notified whenever the data changes in order
     * to be able to properly react to those changes when they occur.
     * 
     * @param data    The new WeatherData value(s)
     */
